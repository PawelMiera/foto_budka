...
class FotoBudka(QDialog):
    def __init__(self):
        ...
        self.press_button = cv2.imread("press_button.png")
        self.black = np.zeros((self.img_height, self.img_width, 3), dtype="uint8")
        ...
        self.countdown_shower = CountdownShower(self.img_width, self.img_height, 70)
